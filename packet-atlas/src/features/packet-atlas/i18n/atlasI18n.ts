...
export const atlasUiText = {
  en: {
    ...
    'motion.layerFocus': 'Layer focus for this animation',
      ...
      'play.layerLadder': 'Layer ladder',
      'play.layerLadderPrompt': 'Climb from user intent down to signals, then back up to meaning.',
      'play.layerLadderActive': 'Active now',
      'play.layerLadderQuiet': 'Background lens',
      'play.evidenceTrail': 'Evidence trail',
      'play.evidenceTrailPrompt': 'Turn the stage into proof: symptom, expected signal, command and conclusion.',
      'play.evidenceSymptom': 'Symptom',
      'play.evidenceSignal': 'Expected signal',
      'play.evidenceCommand': 'Useful command',
      'play.evidenceConclusion': 'Conclusion',
      'play.evidenceOperatorRule': 'Operator rule',
  },
  pl: {
    ...
    'motion.layerFocus': 'Warstwy widoczne w tej animacji',
      ...
      'play.layerLadder': 'Drabina warstw',
      'play.layerLadderPrompt': 'Zejdź od intencji użytkownika do sygnałów, a potem wróć do znaczenia.',
      'play.layerLadderActive': 'Aktywne teraz',
      'play.layerLadderQuiet': 'Tło',
      'play.evidenceTrail': 'Ścieżka dowodowa',
      'play.evidenceTrailPrompt': 'Zamień etap w dowód: objaw, spodziewany sygnał, komenda i wniosek.',
      'play.evidenceSymptom': 'Objaw',
      'play.evidenceSignal': 'Spodziewany sygnał',
      'play.evidenceCommand': 'Przydatna komenda',
      'play.evidenceConclusion': 'Wniosek',
      'play.evidenceOperatorRule': 'Zasada operatora',
  },
} as const
...
const scenarioTextPl: Record<string, string> = {
  ...
  'Application lens': 'Soczewka aplikacji',
  'Application log': 'Log aplikacyjny',
  'Application meaning': 'Znaczenie aplikacyjne',
  'Background lens': 'Tło',
  'Bits, symbols and medium-dependent signals': 'Bity, symbole i sygnały zależne od medium',
  'Boundary transition': 'Przejście przez granicę',
  'Browser checks': 'Sprawdzenia przeglądarki',
  'Browser devtools': 'Narzędzia deweloperskie przeglądarki',
  'Browser render': 'Render przeglądarki',
  'Browser, URL, HTTP, DNS and app meaning': 'Przeglądarka, URL, HTTP, DNS i znaczenie aplikacyjne',
  'Climb from user intent down to signals, then back up to meaning.': 'Zejdź od intencji użytkownika do sygnałów, a potem wróć do znaczenia.',
  ...
  'Do not debug by vibe. Debug by narrowing the boundary.': 'Nie diagnozuj na wyczucie. Diagnozuj przez zawężanie granicy.',
  ...
  'Evidence trail': 'Ścieżka dowodowa',
  ...
  'HTTP status and headers': 'Status HTTP i nagłówki',
  'Human': 'Człowiek',
  'Human / browser UI': 'Człowiek / UI przeglądarki',
  'Human lens': 'Soczewka człowieka',
  'IP addressing, routing, NAT and TTL': 'Adresacja IP, routowanie, NAT i TTL',
  ...
  'Is the content readable here or protected by encryption?': 'Czy treść jest tutaj czytelna, czy chroniona szyfrowaniem?',
  'LAN frame': 'Ramka LAN',
  'Layer ladder': 'Drabina warstw',
  ...
  'MAC-to-MAC delivery on one local hop': 'Dostarczenie MAC-do-MAC w jednym lokalnym skoku',
  ...
  'Network lens': 'Soczewka sieci',
  'Network wrapper': 'Opakowanie sieciowe',
  'One packet journey, many lenses.': 'Jedna podróż pakietu, wiele soczewek.',
  'Only claim what the evidence can support.': 'Twierdź tylko to, co potwierdza dowód.',
  ...
  'Packet capture': 'Przechwycenie pakietów',
  'Physical lens': 'Soczewka fizyczna',
  ...
  'Ports, streams, connections and reliability': 'Porty, strumienie, połączenia i niezawodność',
  ...
  'Security boundary and encrypted content': 'Granica bezpieczeństwa i zaszyfrowana treść',
  ...
  'Start': 'Start',
  'Start with the boundary, then choose the tool.': 'Zacznij od granicy, potem wybierz narzędzie.',
  'Still just waiting.': 'Nadal po prostu czekasz.',
  'Study snapshot': 'Migawka nauki',
  'TCP connection state': 'Stan połączenia TCP',
  'TCP handshake': 'Uzgodnienie TCP',
  'TLS certificate details': 'Szczegóły certyfikatu TLS',
  'TLS handshake': 'Uzgodnienie TLS',
  'TLS lens': 'Soczewka TLS',
  ...
  'Terminal command': 'Komenda terminala',
  ...
  'The current stage should leave a trace in at least one layer-specific view.': 'Obecny etap powinien zostawić ślad w co najmniej jednym widoku właściwym dla warstwy.',
  ...
  'The user sees a simple waiting state, but the network has many possible checkpoints.': 'Użytkownik widzi prosty stan oczekiwania, ale sieć ma wiele możliwych punktów kontrolnych.',
  ...
  'Transport lens': 'Soczewka transportu',
  'Transport wrapper': 'Opakowanie transportowe',
  'Turn the stage into proof: symptom, expected signal, command and conclusion.': 'Zamień etap w dowód: objaw, spodziewany sygnał, komenda i wniosek.',
  'URL intent': 'Intencja URL',
  'Use browser devtools, terminal commands or capture evidence depending on the layer.': 'Użyj narzędzi deweloperskich przeglądarki, komend terminala albo przechwycenia zależnie od warstwy.',
  'Use the analogy to remember this stage.': 'Użyj analogii, żeby zapamiętać ten etap.',
  'User auth': 'Uwierzytelnienie użytkownika',
  'User intent and visible result': 'Intencja użytkownika i widoczny rezultat',
  ...
  'What application meaning is being created or consumed?': 'Jakie znaczenie aplikacyjne jest tworzone albo odbierane?',
  'What changed compared with the previous boundary?': 'Co zmieniło się względem poprzedniej granicy?',
  'What does the user believe is happening?': 'Co użytkownik uważa, że się dzieje?',
  ...
  'What would be different if this stage failed?': 'Co byłoby inne, gdyby ten etap się nie udał?',
  'What would this look like as bits or signals on the medium?': 'Jak wyglądałoby to jako bity albo sygnały w medium?',
  'Where did the journey last look correct?': 'Gdzie podróż ostatnio wyglądała poprawnie?',
  'Which IP addresses and route decisions matter here?': 'Jakie adresy IP i decyzje routingu mają tu znaczenie?',
  'Which layer changed the form of the payload?': 'Która warstwa zmieniła formę ładunku?',
  'Which local MAC hop carries the frame right now?': 'Który lokalny skok MAC przenosi teraz ramkę?',
  'Which observer would see this evidence?': 'Który obserwator zobaczyłby ten dowód?',
  'Which ports and connection state identify this flow?': 'Jakie porty i stan połączenia identyfikują ten przepływ?',
