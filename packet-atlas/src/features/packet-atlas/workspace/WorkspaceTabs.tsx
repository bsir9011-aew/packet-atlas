...
import { ExplainThisScreenPanel } from '../screen-explain/ExplainThisScreenPanel'
  ...
  return (
    <section className="workspace-shell" aria-label="Packet Atlas workspaces">
      <div className="workspace-shell__header">
        ...
        <div className="workspace-shell__badge">v12.7 scenario selector</div>
      </div>
        ...
        {activeWorkspace === 'capture' && (
          <div className="workspace-body__stack">
            <PanelCluster
              ...
              note="Read this workspace top-down: first the guide, then HTTPS vs HTTP contrast, then detailed fixture evidence. The browser reads normalized JSON, not PCAP directly."
            >
              <CaptureWorkspaceGuidePanel />
